# tachyons-modular-debug-children 1.0.0

Modules to debug layout issues http://tachyons.io.
...
```
<link rel="stylesheet" href="http://unpkg.com/tachyons-modular-debug-children@1.0.0/build/build.min.css" />
```
