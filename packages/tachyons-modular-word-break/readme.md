# tachyons-modular-word-break 1.0.0

A module for doing things with word-break http://tachyons.io.
...
```
<link rel="stylesheet" href="http://unpkg.com/tachyons-modular-word-break@1.0.0/build/build.min.css" />
```
