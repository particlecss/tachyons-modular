# tachyons-modular-font-weight 1.0.0

Single purpose classes to set font-weight http://tachyons.io.
...
```
<link rel="stylesheet" href="http://unpkg.com/tachyons-modular-font-weight@1.0.0/build/build.min.css" />
```
