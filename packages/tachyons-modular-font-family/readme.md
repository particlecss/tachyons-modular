# tachyons-modular-font-family 1.0.0

CSS module for setting font-family http://tachyons.io.
...
```
<link rel="stylesheet" href="http://unpkg.com/tachyons-modular-font-family@1.0.0/build/build.min.css" />
```
