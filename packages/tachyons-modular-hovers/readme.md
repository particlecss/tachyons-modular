...
http:
```
git clone https://github.com/tachyons-css/tachyons-modular-hovers
```

ssh:
```
git clone git@github.com:tachyons-css/tachyons-modular-hovers.git
```
...
```
<link rel="stylesheet" href="http://unpkg.com/tachyons-modular-hovers@1.0.0/css/tachyons-modular-hovers.min.css" />
```
...
```html
<link rel="stylesheet" href="path/to/module/css/tachyons-modular-hovers">
```
