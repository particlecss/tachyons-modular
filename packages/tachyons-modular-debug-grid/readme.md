# tachyons-modular-debug-grid 1.0.0
...
```
npm install --save-dev tachyons-modular-debug-grid
```
...
http:
```
git clone https://github.com/tachyons-css/tachyons-modular-debug-grid
```

ssh:
```
git clone git@github.com:tachyons-css/tachyons-modular-debug-grid.git
```
...
```css
@import "tachyons-modular-debug-grid";
```
...
```
<link rel="stylesheet" href="http://unpkg.com/tachyons-modular-debug-grid@1.0.0/css/tachyons-modular-debug-grid.min.css" />
```
...
```html
<link rel="stylesheet" href="path/to/module/css/tachyons-modular-debug-grid">
```
