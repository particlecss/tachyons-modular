# tachyons-modular-debug 1.0.0

Debug partial for debugging css http://tachyons.io
...
```
<link rel="stylesheet" href="http://unpkg.com/tachyons-modular-debug@1.0.0/build/build.min.css" />
```
